...
I'll use *Lucy*'s *updateVertices* function, which will apply the following callback function to each vertex.  
...
Finally, I apply "updateVertices":

```{r, eval = FALSE}
g$lambda <- 10
g_fit <- updateVertices(g, iparents, do_glmnet)
```
