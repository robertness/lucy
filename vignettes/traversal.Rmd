...
* At each node a calculation is performed.  The result of the calculation is stored as an attributed of that node.
* Each node has another attribute, "updated", which initially has the value of FALSE, and becomes TRUE after the calculation is successfully completed.
